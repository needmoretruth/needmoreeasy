...
DOCUMENTED_LISTS = [
    ...
    "SAY_TRAILING_WORDS_KO", "SAY_SHORT_WORDS_KO",
    "SCREEN_TAIL_WORDS_EN", "SCREEN_TAIL_WORDS_KO",
    "SCREEN_VERB_WORDS_EN", "SCREEN_VERB_WORDS_KO",
    "ASK_WORDS_EN", "ASK_WORDS_KO",
    "ASK_QUESTION_WORDS_EN", "ASK_QUESTION_WORDS_KO", "ASK_SHORT_WORDS_KO",
    ...
    "STORY_WORDS_EN", "STORY_WORDS_KO",
    "STORY_SLOW_WORDS_EN", "STORY_SLOW_WORDS_KO",
    "CHANCE_WORDS_EN", "CHANCE_WORDS_KO",
    "CHANCE_PERCENT_WORDS_EN", "CHANCE_PERCENT_WORDS_KO",
    "CHANCE_TIME_WORDS_EN", "CHANCE_LEAD_WORDS_EN",
    "CHANCE_PARTICLES_KO", "CHANCE_IS_WORDS_EN",
    "EMPTY_WORDS_EN", "EMPTY_WORDS_KO",
    "COUNT_WORDS_EN", "COUNT_WORDS_KO", "READING_LEAD_WORDS_EN",
    "LENGTH_WORDS_EN", "LENGTH_WORDS_KO",
    "TOTAL_WORDS_EN", "TOTAL_WORDS_KO",
    "LARGEST_WORDS_EN", "LARGEST_WORDS_KO",
    "SMALLEST_WORDS_EN", "SMALLEST_WORDS_KO",
    "EXTREME_SCOPE_WORDS_KO", "EXTREME_MOST_WORDS_KO", "EXTREME_THING_WORDS_KO",
    "FIRST_WORDS_EN", "FIRST_WORDS_KO",
    "LAST_WORDS_EN", "LAST_WORDS_KO",
    "ITEM_WORDS_EN", "ITEM_WORDS_KO",
    "CAPITALS_WORDS_EN", "CAPITALS_WORDS_KO",
    "SMALL_LETTERS_WORDS_EN", "SMALL_LETTERS_WORDS_KO",
    "JOIN_WORDS_EN", "JOIN_WORDS_KO",
    "JOIN_TOGETHER_WORDS_EN", "JOIN_TOGETHER_WORDS_KO",
    "EMPTY_SEPARATOR_WORDS_EN", "EMPTY_SEPARATOR_WORDS_KO",
    "SPLIT_WORDS_EN", "SPLIT_WORDS_KO",
    "SPLIT_LINE_WORDS_EN", "SPLIT_LINE_WORDS_KO",
    "SPLIT_THING_WORDS_KO",
    "REPEAT_TEXT_WORDS_EN", "REPEAT_TEXT_WORDS_KO",
    "COPIES_WORDS_EN", "COPIES_WORDS_KO",
    "POSITION_WORDS_EN", "POSITION_WORDS_KO",
    "SEPARATOR_WORDS_EN", "SEPARATOR_WORDS_KO",
    "SORT_WORDS_EN", "SORT_WORDS_KO",
    "REVERSE_WORDS_EN", "REVERSE_WORDS_KO",
    "SHUFFLE_WORDS_EN", "SHUFFLE_WORDS_KO",
    "CONTAINS_WORDS_EN", "CONTAINS_WORDS_KO",
    "FOREVER_WORDS_EN", "FOREVER_WORDS_KO",
    "READING_PARTICLES_KO",
