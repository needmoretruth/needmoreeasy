...
Then confirm that `nme --version` is the supported beta (currently `0.0.1-beta.12`), then write the requested program as a .nme file, prefer sentence syntax for a
