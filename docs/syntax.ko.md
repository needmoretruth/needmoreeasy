...
한국어 어미는 줄여 써도 됩니다: `같다면` · `같으면` · `같을` · `같지않다면` · `같지않으면` · `같지않을` · `경우` · `그러면` · `그럼` · `넘는다면` · `넘으면` · `넘을` · `때` · `라면` · `많다면` · `많으면` · `많을` · `면` · `모자라면` · `미만면` · `미만이면` · `미만인` · `미만일` · `비어있다면` · `비어있으면` · `비었다면` · `비었으면` · `안되면` · `없다면` · `없으면` · `이라면` · `이면` · `이상이면` · `이상인` · `이상일` · `이하이면` · `이하인` · `이하일` · `일때` · `있다면` · `있으면` · `작거나같다면` · `작거나같으면` · `작거나같은` · `작거나같을` · `작다면` · `작으면` · `작을` · `적다면` · `적으면` · `적을` · `초과면` · `초과이면` · `초과인` · `초과일` · `크거나같다면` · `크거나같으면` · `크거나같은` · `크거나같을` · `크다면` · `크면` · `클` · `하면`
