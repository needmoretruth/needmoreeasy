...
한국어 어미는 줄여 써도 됩니다: `같다면` · `같으면` · `같지않다면` · `같지않으면` · `같지않을` · `경우` · `그러면` · `그럼` · `때` · `라면` · `면` · `미만면` · `미만이면` · `없다면` · `없으면` · `이라면` · `이면` · `일때` · `있다면` · `있으면` · `작거나같다면` · `작거나같으면` · `작다면` · `작으면` · `작을` · `초과면` · `초과이면` · `크거나같다면` · `크거나같으면` · `크다면` · `크면` · `클` · `하면`
