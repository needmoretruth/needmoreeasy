...
The current release is `0.0.1-beta.8`; the public line began at
`0.0.1-beta.1`. Later public beta releases increase the last number:
`0.0.1-beta.3`, `0.0.1-beta.4`, `0.0.1-beta.5`, `0.0.1-beta.6`, `0.0.1-beta.7`, `0.0.1-beta.8`, and so on. A Git commit or a branch push is not
