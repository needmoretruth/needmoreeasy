# 50 — 편집기 — 아주 작은 텍스트 에디터

[English](50-editor.md) | 한국어

[README](../../README.ko.md) | [설치](../install.ko.md) | [시작하기](../getting-started.ko.md) | [학습 과정](../tutorial.ko.md) | [문법 안내](../language.ko.md) | [가이드](index.ko.md)

- 난이도: ★★★★★ (5/5)
- 선수 지식: [21 — 진행](21-progress.ko.md), [37 — 파일](37-files.ko.md)
- 주제: 프로젝트
...
2. 버퍼는 실행 사이에도 파일에 남습니다. [37](37-files.ko.md)에서처럼
...
3. 명령은 한 줄로 들어옵니다. `줄.split()`이 공백으로 나누고, `parts[0]`이
   ...
   [79](79-tokens.ko.md)도 같은 방식으로 토큰을 나눕니다:
