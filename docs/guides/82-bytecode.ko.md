# 82 — 컴파일러: 작은 바이트코드 실행기

[English](82-bytecode.md) | 한국어

[README](../../README.ko.md) | [설치](../install.ko.md) | [시작하기](../getting-started.ko.md) | [학습 과정](../tutorial.ko.md) | [문법 안내](../language.ko.md) | [가이드](index.ko.md)

- 난이도: ★★★★★ (5/5)
- 선수 지식: [79 — 토큰](79-tokens.ko.md), [80 — AST](80-ast.ko.md)
- 주제: 언어 만들기
- 결과물: 간단한 명령을 단계 목록으로 컴파일하고 가상 머신처럼 한 단계씩 실행하기

가이드 [84](84-bootstrap.ko.md)는 소스 텍스트를 Python으로 번역해 실행하고,
[79](79-tokens.ko.md)는 줄을 토큰으로 나누어 실행을 보냈습니다. 다음 단계는
