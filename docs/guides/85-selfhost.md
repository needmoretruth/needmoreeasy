# 85 — Self-host: NME running NME

English | [한국어](85-selfhost.ko.md)
...
4. Korean writes the same compiler; only the comments and report lines change. The full program is in the [Korean guide](85-selfhost.ko.md).
