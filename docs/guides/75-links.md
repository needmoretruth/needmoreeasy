# 75 — Web: extracting links from a page

English | [한국어](75-links.ko.md)
...
4. Each link lives between `href="` and the next `"`. The regex
   ...
   captured parts, as in guide [70](70-patterns.md). Save `links.nme`:
...
an exception, guide [59](59-errors.md) shows how to catch it). Or extract
