# 34 — 셀프호스트: NME가 NME를 실행

[English](34-selfhost.md) | 한국어
...
2. 컴파일러 전체입니다. `selfhost.ko.nme`로 저장합니다:
   ...
   `split()`이 각 줄을 단어로 나누고, `indent`가 블록 깊이를 관리하며, `exec(source)`가 만들어진 Python을 실행합니다 — [29](29-bootstrap.ko.md)의 방법입니다.
...
4. 영어는 같은 컴파일러를 `show`로 씁니다; 전체 프로그램은 [영어 가이드](34-selfhost.md)에 있습니다.
