...
- 난이도: ★★★★☆ (4/5)
- 선수 지식: [24 — 퀴즈](24-quiz.ko.md), [22 — 터미널 메뉴](22-terminal-menu.ko.md)
- 주제: 프로젝트
- 결과물: 사고팔고 재고를 확인하며 잔액이 남는 JSON 저장 상점

[35](35-todo.ko.md)은 목록을 저장하고, [41](41-address-book.ko.md)은
기록을 저장합니다. 상점은 그 생각을 한 단계 키운 것입니다: 각 상품이
