...
19. [19 — Game: a reaction time test](19-reaction.md)
...
23. [23 — High score: a tiny project](23-high-score.md)
...
27. [27 — Game: Mastermind, guessing a secret code](27-mastermind.md)
28. [28 — Game: a simple opponent](28-ai.md)
...
40. [40 — CSV: rows of data](40-csv.md)
...
- changing values: [06](06-update.md)
- loops: [07](07-repeat.md), [11](11-break.md)
...
- game: [17](17-word-guess.md), [26](26-tic-tac-toe.md)
- a small project: [18](18-adventure.md)
- game & timing: [19](19-reaction.md)
- output & loops: [20](20-ascii-art.md)
- terminal output: [21](21-progress.md)
- terminal menus: [22](22-terminal-menu.md)
- project: [23](23-high-score.md)
- game & data: [24](24-quiz.md)
- a project: [25](25-calculator.md), [30](30-shop.md), [31](31-bank.md), [33](33-habit.md), [35](35-todo.md)
- game & logic: [27](27-mastermind.md)
- game & strategy: [28](28-ai.md)
- game & random: [29](29-playlist.md)
- a capstone project: [32](32-grade-book.md)
- visualization: [34](34-chart.md)
- files: [36](36-diary.md), [37](37-files.md), [49](49-report.md)
- files and lists: [38](38-name-list.md)
- json: [39](39-json.md)
- data: [40](40-csv.md), [42](42-word-count.md), [45](45-group.md), [52](52-sorting.md), [58](58-data.md)
- records: [41](41-address-book.md)
- text & data: [43](43-text-stats.md)
- files & logging: [44](44-log.md)
- data & ranking: [46](46-top-ten.md)
- search & data: [47](47-search.md)
- files & folders: [48](48-files-folder.md)
- a terminal app: [50](50-editor.md)
- strings: [51](51-strings.md)
- sets & data: [53](53-sets.md)
- data & merging: [54](54-merge.md)
- nested data: [55](55-grid.md)
- algorithm: [56](56-bubble.md), [57](57-binary-search.md)
- exceptions: [59](59-errors.md)
- testing: [60](60-testing.md)
- modules: [61](61-modules.md)
- modules & structure: [62](62-project-files.md)
- command-line tools: [63](63-argv.md)
- Python packages: [64](64-python-packages.md)
- native compilation: [66](66-native.md)
- statistics: [67](67-stats.md)
- data & comparison: [68](68-compare.md)
- data analysis: [69](69-analysis.md)
- regular expressions: [70](70-patterns.md)
- networks and HTTP: [71](71-http.md)
- web data: [72](72-weather.md)
- network & timing: [73](73-poll.md)
- network & files: [74](74-download.md)
- web & text: [75](75-links.md)
- network: [76](76-net.md)
- compiler: [77](77-compiler.md), [78](78-expressions.md), [79](79-tokens.md), [82](82-bytecode.md)
- compiler & AST: [80](80-ast.md)
- compiler & functions: [81](81-functions.md)
- compiler & bytecode: [83](83-bytecode-compiler.md)
- bootstrap: [84](84-bootstrap.md)
- self-hosting: [85](85-selfhost.md)
- compiler capstone: [86](86-capstone.md)
- cryptocurrency ledger and transactions: [87](87-blockchain.md)
- proof of work and block linkage: [88](88-proof-of-work.md)
- transaction proofs and replay prevention: [89](89-signatures.md)
- chain validation and consensus boundaries: [90](90-consensus.md)
...
| 06 | ★☆☆☆☆ | changing values | [Update: change a value](06-update.md) | a program that adds to and subtracts from a score |
| 07 | ★★☆☆☆ | loops | [Repeat: do something many times](07-repeat.md) | a program that repeats lines, walks a list, and pauses |
| 08 | ★★☆☆☆ | conditions | [If: make a choice](08-if.md) | a program that runs different lines depending on a condition |
...
| 32 | ★★★★☆ | a capstone project | [Project — a grade book](32-grade-book.md) | a JSON-persisted grade book with add-student, add-grade, report-averages, and a storage module |
| 33 | ★★★★☆ | a project | [Project: a habit tracker](33-habit.md) | a JSON-persisted habit tracker with add, check, streak, list, quit, and a module file for the storage logic |
...
| 44 | ★★★★★ | files & logging | [Log: an event record](44-log.md) | appending a dated line to a log file each time the program runs, using datetime and file_write |
| 45 | ★★★★★ | data | [Group: data by category](45-group.md) | grouping a list of dicts by a category key into a dict of lists, then reporting counts per category |
| 46 | ★★★★★ | data & ranking | [Top ten: ranking records](46-top-ten.md) | loading JSON records, sorting by a numeric score with sorted(..., key=...), and showing the top ten |
| 47 | ★★★★★ | search & data | [Search — finding items in JSON](47-search.md) | loading a JSON catalog from a local server or file and searching it by keyword, case-insensitively |
| 48 | ★★★★★ | files & folders | [Files: processing many files](48-files-folder.md) | listing the files in a folder with os.listdir, reading each with file_read, and reporting total words and letters across all of them |
| 49 | ★★★★★ | files | [Report — writing a summary file](49-report.md) | reading a few JSON data files and writing one text report with file_write |
| 50 | ★★★★★ | a terminal app | [Editor — a tiny text editor](50-editor.md) | a line-based editor with a buffer and add, list, remove, save, and quit commands |
| 51 | ★★★★☆ | strings | [Strings: slicing and changing text](51-strings.md) | slicing `text[start:end]`, `.upper()/.lower()`, `.replace()`, and `.strip()` on a sentence |
| 52 | ★★★★☆ | data | [Sorting — putting a list in order](52-sorting.md) | loading numbers from a JSON file and showing sorted ascending and descending orders with the Python sort method |
...
| 54 | ★★★★★ | data & merging | [Merge: joining two lists](54-merge.md) | loading two JSON lists and joining records by name key into one report |
| 55 | ★★★★★ | nested data | [Grid: a board of lists](55-grid.md) | a tic-tac-toe style 3x3 board stored as a list of lists, reading and writing cells with `board[row][col]` |
| 56 | ★★★★★ | algorithm | [Bubble sort — your first algorithm](56-bubble.md) | implementing bubble sort by hand with nested loops and a swap, then comparing the result with Python's built-in sort |
| 57 | ★★★★★ | algorithm | [Binary search — halving the guess](57-binary-search.md) | finding a number in a sorted list by halving the search range each step, showing the step count and the found index |
| 58 | ★★★★★ | data | [Data: statistics on a list](58-data.md) | loading numbers from a JSON file and computing mean/median/max with the statistics standard library |
| 59 | ★★★★☆ | exceptions | [Errors: handling problems](59-errors.md) | a program that reads a missing file and converts bad input without crashing |
| 60 | ★★★★☆ | testing | [Testing: checking the functions you wrote](60-testing.md) | a tiny test runner that calls your own functions, compares each result with the expected value, and reports pass or fail |
| 61 | ★★★★☆ | modules | [Modules: split your program into files](61-modules.md) | splitting a program across .nme files |
| 62 | ★★★★☆ | modules & structure | [Modules: a project across files](62-project-files.md) | a small weather-report project split into three .nme modules (fetch, analyze, report) with clear interfaces, imported by a main program |
| 63 | ★★★★☆ | command-line tools | [Tools: reading command-line arguments](63-argv.md) | a todo tool that takes commands like `nme r todo add "buy milk"` on the command line |
| 64 | ★★★★☆ | Python packages | [Python packages: the standard library and installed libraries](64-python-packages.md) | using the standard library and installed libraries |
| 65 | ★★★★☆ | using the tools | [Convert: turn Python into NME](65-convert.md) | a small Python file converted into NME |
| 66 | ★★★★☆ | native compilation | [Native: compile to machine code](66-native.md) | running a program as machine code without CPython |
| 67 | ★★★★★ | statistics | [Stats: understanding data](67-stats.md) | loading a JSON list and reporting count, mean, median, mode, min, max, and range |
| 68 | ★★★★★ | data & comparison | [Compare: two groups of numbers](68-compare.md) | loading two JSON number lists and comparing their means and maxima |
| 69 | ★★★★★ | data analysis | [Data: analyzing a month of temperatures](69-analysis.md) | loading a month of temperatures, computing statistics and a histogram, and saving a report file |
| 70 | ★★★★★ | regular expressions | [Patterns: finding matches with regex](70-patterns.md) | a program that finds phone numbers and email addresses in a text file |
| 71 | ★★★★★ | networks and HTTP | [HTTP — asking a web server](71-http.md) | fetching a page from a local server |
| 72 | ★★★★★ | web data | [Weather: reading JSON from the web](72-weather.md) | fetching a local HTTP server's JSON and printing a mini weather report |
| 73 | ★★★★★ | network & timing | [Network: polling a server](73-poll.md) | repeatedly fetching a status.json from a local server every few seconds and reporting changes |
| 74 | ★★★★★ | network & files | [Network: downloading files](74-download.md) | downloading a file from a local HTTP server and saving it while showing progress |
| 75 | ★★★★★ | web & text | [Web: extracting links from a page](75-links.md) | fetching an HTML page from a local server and listing every link on it as a full URL |
| 76 | ★★★★★ | network | [Network: a mini chat](76-net.md) | fetching messages from a local HTTP server and showing them like a mini chat |
| 77 | ★★★★☆ | compiler | [Your first compiler — a tiny language](77-compiler.md) | a tiny language that reads lines like `add 2 3` and prints the answer |
| 78 | ★★★★☆ | compiler | [Compiler tier: a small expression language](78-expressions.md) | a tiny calculator that evaluates 2 + 3 * 4 respecting precedence, as a step toward a real expression compiler |
| 79 | ★★★★☆ | compiler | [Compiler tier: reading tokens](79-tokens.md) | splitting a command line into tokens and dispatching them, a step toward a real tokenizer and parser |
| 80 | ★★★★★ | compiler & AST | [Compiler tier: expressions as trees](80-ast.md) | a calculator that parses an expression into a tree and evaluates the tree recursively, respecting precedence |
| 81 | ★★★★★ | compiler & functions | [Compiler tier: functions in the mini language](81-functions.md) | a compiler that translates a mini language with `def`, `return`, and calls into Python and runs it |
| 82 | ★★★★★ | compiler | [Compiler tier: a tiny bytecode runner](82-bytecode.md) | compiling simple instructions into a list of steps and running them one by one like a tiny virtual machine |
| 83 | ★★★★★ | compiler & bytecode | [Compiler tier: from tree to bytecode](83-bytecode-compiler.md) | a compiler that flattens an expression tree into instruction lines and runs them on a stack machine |
| 84 | ★★★★★ | bootstrap | [Bootstrap: NME compiling a tiny language](84-bootstrap.md) | a tiny compiler written in NME |
| 85 | ★★★★★ | self-hosting | [Self-host: NME running NME](85-selfhost.md) | an NME program that compiles a tiny NME-like subset (say/set/while) to Python |
| 86 | ★★★★★ | compiler capstone | [Capstone: a language that compiles to Python](86-capstone.md) | an NME program that reads a small custom language (say/set/add/while/end), compiles it to Python source, writes it to a file, and runs it |
| 87 | ★★★☆☆ | cryptocurrency ledger and transactions | [Cryptocurrency ledger — state and transactions](87-blockchain.md) | a small cryptocurrency ledger with balances, fees, supply, and transaction nonces |
| 88 | ★★★☆☆ | proof of work and block linkage | [Proof of work — mining transaction blocks](88-proof-of-work.md) | link transactions to the previous block and perform SHA-256 proof of work |
| 89 | ★★★☆☆ | transaction proofs and replay prevention | [Transaction proofs — wallet ownership and replay prevention](89-signatures.md) | validate transaction authorization with a public value and reject replay |
| 90 | ★★★☆☆ | chain validation and consensus boundaries | [Full-chain validation — recompute from genesis](90-consensus.md) | a single-node validator that replays every transaction and block from genesis |
