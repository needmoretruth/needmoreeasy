# 60 — Testing: checking the functions you wrote

English | [한국어](60-testing.ko.md)
...
2. The runner walks the rows, calls each function, and compares. The
   ...
   was a value in guide [12](12-random.md). Save `testcalc.nme`:
...
5. A test runner protects a growing project. Put the functions in a module
   (guide [61](61-modules.md)) and the tests in the main file, then run the
