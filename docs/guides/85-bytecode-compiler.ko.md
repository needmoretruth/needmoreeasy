...
[English](85-bytecode-compiler.md) | 한국어
...
[82](82-ast.md)는 트리를 직접 평가했고, [58](58-bytecode.md)은 미리
...
2. 컴파일은 [82](82-ast.md) 트리의 재귀 순회입니다. 숫자는 `PUSH`
...
3. VM은 작은 스택을 가진 루프입니다. [82](82-ast.md)의 토크나이저와
...
컴파일되게 하세요. `sys.argv[1]`에서 식을 읽으면([80](80-argv.md))
