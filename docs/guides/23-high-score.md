...
- Difficulty: ★★★★☆ (4/5)
- Prerequisites: [12 — Random](12-random.md), [22 — Terminal menu](22-terminal-menu.md)
- Topic: project
...
4. Korean writes the same project with `랜덤 사용 최신`, `파일 사용 최신`,
   ...
   [Korean guide](23-high-score.ko.md); this snippet loads a saved best:
