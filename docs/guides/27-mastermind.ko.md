...
- 난이도: ★★★★☆ (4/5)
- 선수 지식: [12 — 랜덤](12-random.ko.md), [17 — 단어 맞히기](17-word-guess.ko.md)
- 주제: 게임/논리
...
1. 비밀 코드는 색 목록에서 네 번 고른 것입니다 — [12](12-random.ko.md)의
   ...
   `append`가 목록을 색 하나씩 키웁니다 — [29](29-playlist.ko.md) 가이드가
   플레이리스트를 만들 때 쓰는 것과 같은 목록 쌓기 루프입니다.
