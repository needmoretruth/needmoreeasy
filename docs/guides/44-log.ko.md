...
[English](44-log.md) | 한국어

[README](../../README.ko.md) | [설치](../install.ko.md) | [시작하기](../getting-started.ko.md) | [학습 과정](../tutorial.ko.md) | [문법 안내](../language.ko.md) | [가이드](index.ko.md)

- 난이도: ★★★★★ (5/5)
- 선수 지식: [37 — 파일](37-files.ko.md), [36 — 일기](36-diary.ko.md)
- 주제: 파일/기록
- 결과물: 프로그램이 실행될 때마다 datetime과 file_write로 로그 파일에 날짜 줄을 덧붙이기

가이드 [36](36-diary.ko.md)의 일기는 날마다 파일 하나를 씁니다. **로그**는
...
1. `datetime`에게 지금을 물어보고 텍스트로 만드세요. `datetime.now()`는 바로
   이 순간이고, `strftime`(가이드 [64](64-python-packages.ko.md))이 형식을
...
2. 가이드 [37](37-files.ko.md)의 `file_write`는 파일 전체를 덮어씁니다. 그래서
...
가이드 [42](42-word-count.ko.md)의 dict 세기로 같은 날짜 줄이 몇 개인지 세세요.
