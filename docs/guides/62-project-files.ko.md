...
[English](62-project-files.md) | 한국어

[README](../../README.ko.md) | [설치](../install.ko.md) | [시작하기](../getting-started.ko.md) | [학습 과정](../tutorial.ko.md) | [문법 안내](../language.ko.md) | [가이드](index.ko.md)

- 난이도: ★★★★☆ (4/5)
- 선수 지식: [32 — 성적부](32-grade-book.ko.md), [61 — 모듈](61-modules.ko.md)
- 주제: 프로그램이 커질 때
- 결과물: fetch·analyze·report 세 .nme 모듈로 나누고 주 프로그램이 가져오는 작은 날씨 보고서 프로젝트

[61](61-modules.ko.md)은 프로그램에서 도우미를 나누었고,
[32](32-grade-book.ko.md)은 저장 모듈 하나를 썼습니다. 진짜 프로젝트는
...
2. `fetch_ko.nme`은 입력 모듈입니다. 파일을 읽는 일만 합니다.
   [39](39-json.ko.md)의 `파일 사용` 모듈이 읽기를 담당합니다:
...
3. `analyze_ko.nme`은 계산 담당입니다. `평균`은 기온을 더하고 나눕니다
   ([67](67-stats.ko.md)와 같습니다), `가장더운날`은 `if`로 날들을 훑으며
   가장 따뜻한 날을 기억합니다:
...
8. 영어는 같은 프로젝트를 `use file latest`, `json_load`, `show`와
   ...
   [영어 가이드](62-project-files.md)에 있습니다.
