...
[English](46-top-ten.md) | 한국어

[README](../../README.ko.md) | [설치](../install.ko.md) | [시작하기](../getting-started.ko.md) | [학습 과정](../tutorial.ko.md) | [문법 안내](../language.ko.md) | [가이드](index.ko.md)

- 난이도: ★★★★★ (5/5)
- 선수 지식: [41 — 기록](41-address-book.ko.md), [45 — 묶기](45-group.ko.md)
- 주제: 데이터/순위
- 결과물: JSON 기록을 불러와 숫자 점수 기준으로 정렬하고 상위 열 개를 보여 주는 프로그램

[52](52-sorting.ko.md)는 숫자를 정렬하고, [67](67-stats.ko.md)는 그 숫자를
요약합니다. 실제 데이터는 기록들의 목록이고, 기록 하나는 여러 필드가 든
...
2. [39](39-json.ko.md)의 `json읽기`로 목록을 불러옵니다:
...
7. 영어는 같은 단계를 `use file latest`, `json_load`, `show`로 씁니다.
   전체 영어 프로그램은 [영어 가이드](46-top-ten.md)에 있습니다.
