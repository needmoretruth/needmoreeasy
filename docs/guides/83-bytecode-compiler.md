# 83 — Compiler tier: from tree to bytecode

English | [한국어](83-bytecode-compiler.ko.md)
...
2. Compiling is a recursive walk of the tree from guide [80](80-ast.md).
...
3. The VM is a loop with a small stack. Save `bytecode.nme` with the
   tokenizer and parsers of guide [80](80-ast.md):
...
`sys.argv[1]` (guide [63](63-argv.md)) to turn the whole pipeline into a
