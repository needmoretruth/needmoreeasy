# 80 — Compiler tier: expressions as trees

English | [한국어](80-ast.ko.md)
...
[82](82-bytecode.md) flattens instructions into data. Real compilers do
...
2. Building the tree needs two functions, because `*` binds tighter than
   ...
   like the one that computed factorials in guide [66](66-native.md).
...
read from `sys.argv[1]` (guide [63](63-argv.md)): `nme r ast "2 + 3 * 4"`.
