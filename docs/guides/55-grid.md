# 55 — Grid: a board of lists

English | [한국어](55-grid.ko.md)
...
4. Run it:
   ...
   ```
   Writing then reading back a cell gives exactly what was stored — that is the whole point of a grid. Guide [26](26-tic-tac-toe.md) turns this board into a playable game.
## Try it yourself
