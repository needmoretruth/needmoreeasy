...
Expected NME version: `0.0.1-beta.15`. The `$env:Path` line makes the
...
Expected NME version: `0.0.1-beta.15`. The `export` line must run before the
...
Expected NME version: `0.0.1-beta.15`. The `export` line is deliberately
before `nme --version`.
