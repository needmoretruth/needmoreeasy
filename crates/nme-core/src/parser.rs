...
fn korean_reading_prefix(
    ...
    // the number it was written as. Inside a condition the closing word wears
    // the subject particle (`바꾼 것이 42와 같으면`), so it is matched the way
    // every other reading matches its own closing word.
    if rest.len() > 2
        && token_matches_exact(&rest[0], NUMBER_WORDS)
        && token_matches_exact(&rest[1], CHANGED_WORDS_KO)
        && reading_word_matches(name_word(&rest[2])?, SPLIT_THING_WORDS_KO)
    {
...
const COMMON_ENGLISH_WORDS: &[&str] = &[
    ...
    "behind", "behinds", "being", "beings", "belay", "believe", "beling", "bell", "bellow",
    "below", "belows", "bend", "bently", "bequest", "beside", "besided", "besides", "best",
    "betide", "beting", "better", "between", "betweens", "beying", "beyonds", "bfing", "bicely",
    "bidly", "big", "biggests", "bight", "biing", "bill", "binally", "bindly", "bine", "bines",
    "bing", "bird", "bit", "bits", "bize", "bking", "black", "bland", "blanks", "blarely",
    "blast", "bleak", "blear", "blearly", "bleep", "bling", "blink", "blip", "block", "bloop",
    "bloops", "blow", "blowly", "blue", "board", "boast", "boat", "bock", "bodly", "body",
    "bold", "bolds", "bonce", "bone", "book", "boon", "boos", "boosts", "boot", "booth",
    "boots", "border", "borely", "born", "borrows", "bort", "bosh", "botch", "both", "bother",
    "bothing", "boths", "bothy", "bots", "bott", "bottom", "bound", "bounds", "bout", "bowl",
    "box", "boxy", "boy", "bping", "bradly", "braely", "braw", "bread", "break", "breaks",
    "bream", "breing", "bright", "bring", "broth", "brother", "brow", "brown", "brut", "buck",
    "budly", "build", "built", "buing", "bumble", "bumf", "bumph", "bumps", "bumpy", "bums",
    "bunt", "buring", "burp", "burrow", "burs", "bush", "business", "bust", "busy", "but",
    "buts", "butt", "buy", "bxing", "by", "bying", "byrely", "cable", "cadly", "cafely", "cain",
    "cake", "calf", "calk", "call", "calla", "calls", "cally", "calm", "cals", "calx", "caly",
    "came", "can", "canc", "cane", "cannon", "cannot", "cannots", "cans", "cant", "capita",
    "capital", "capitals", "capitaly", "capitas", "capitol", "capitols", "car", "cardly",
    "care", "carely", "carl", "carrion", "carry", "carryons", "case", "cask", "cast", "cat",
    "catch", "cater", "caul", "cause", "cave", "cell", "center", "cently", "centre", "cere",
    "cero", "certainty", "chad", "chair", "chance", "chanced", "chancel", "chancels", "chances",
    "chancies", "chancre", "chancres", "chancy", "change", "changes", "chappily", "chardly",
    "chared", "chas", "chat", "check", "chem", "child", "children", "chis", "choose", "choosed",
    "chooser", "chooses", "choosy", "chose", "chough", "chow", "church", "cicely", "cine",
    "cines", "cist", "cither", "cits", "city", "clan", "clank", "class", "clean", "cleanly",
    "clear", "clears", "cleat", "cleatly", "clement", "cline", "clines", "clip", "close",
    "cloudly", "coff", "coin", "coined", "cold", "colds", "coll", "colour", "coma", "come",
    "comm", "commas", "common", "comms", "company", "competely", "complete", "completedly",
    "cone", "cont", "contain", "contains", "conto", "cool", "coon", "coop", "coops", "copy",
    "corner", "cost", "costly", "could", "coulds", "count", "country", "counts", "county",
    "couple", "course", "court", "cover", "coward", "cowards", "craw", "creak", "crest", "crop",
    "cross", "crow", "crowd", "cry", "cull", "cumber", "cunt", "cup", "curing", "curs",
    "curtainly", "cut", "cuts", "cyan", "cycled", "cycles", "dace", "dad", "dadly", "dale",
    "dame", "dare", "dared", "darely", "darer", "dares", "darg", "daring", "dark", "darn",
    "dart", "date", "dater", "daughter", "dawn", "day", "daze", "dead", "deal", "deally",
    "dear", "dearly", "death", "decay", "decide", "decrements", "deep", "degrease", "delate",
    "delays", "deleted", "deletes", "dell", "delly", "dely", "dently", "deplete", "deport",
    "dering", "ders", "dhole", "dhow", "dicely", "dick", "did", "diddle", "dido", "dids", "die",
    "died", "dies", "difference", "different", "difficult", "dight", "dill", "dime", "dimes",
    "dimply", "dine", "dines", "dinner", "dire", "direction", "diring", "discord", "dist",
    "dither", "dits", "dive", "divide", "divided", "divideds", "dividend", "divider", "divides",
    "divine", "divined", "dlring", "do", "dobs", "docs", "doed", "doer", "doers", "does",
    "doff", "dog", "doge", "doges", "dogs", "dole", "doles", "dols", "dome", "domes", "doms",
    "dona", "done", "doned", "donee", "dones", "dong", "donne", "dons", "door", "dope", "dopes",
    "doring", "dorp", "dors", "dose", "doses", "doss", "dostly", "dote", "dotes", "dots",
    "double", "doubt", "dour", "douring", "dours", "dove", "doves", "down", "downs", "downy",
    "dows", "doze", "dozes", "drab", "drag", "dram", "drat", "draw", "drawl", "drawn", "draws",
    "dray", "dread", "dream", "dress", "drew", "dring", "drink", "drip", "drive", "drone",
    "droop", "drop", "drops", "drown", "dry", "dubing", "ducing", "duding", "dues", "duging",
    "duhing", "duing", "duking", "dump", "dune", "duning", "duoing", "duping", "during",
    "durings", "duroing", "dust", "duxing", "dyes", "dyne", "dzes", "each", "ear", "early",
    "earth", "ease", "easely", "east", "eastly", "easy", "eat", "eater", "eave", "echos",
    "echt", "edge", "egg", "eight", "eighth", "eights", "eighty", "either", "eithers", "elapse",
    "elapses", "elements", "else", "elsed", "elses", "elver", "emery", "empty", "enactly",
    "encase", "end", "ends", "ened", "enjoy", "enough", "enoughs", "enow", "enter", "enters",
    "enticely", "entire", "entirety", "epactly", "equal", "eras", "erased", "eraser", "erases",
    "erose", "erst", "esse", "ester", "estop", "etch", "ether", "eved", "evely", "even",
    "evening", "evens", "event", "ever", "everly", "evers", "evert", "every", "everybody",
    "everyone", "everyoned", "everyones", "everything", "everythings", "eves", "ewer",
    "exactly", "exaltly", "example", "except", "excepts", "excerpt", "exch", "expect", "eye",
    "fable", "face", "fact", "fadly", "fail", "fake", "fall", "family", "famous", "far",
    "fardly", "fare", "farely", "farm", "fast", "father", "fave", "feally", "fear", "fearly",
    "fecs", "feel", "feet", "feing", "fell", "felt", "fend", "fest", "fever", "few", "fiddle",
    "field", "fife", "fight", "file", "fill", "film", "final", "finalely", "find", "findly",
    "fine", "fines", "finfish", "finger", "finially", "finis", "finish", "fire", "firs",
    "first", "firsts", "fish", "fist", "fits", "five", "fived", "fives", "fix", "flank", "flap",
    "flips", "flit", "flong", "floor", "flop", "flor", "flour", "flow", "flower", "flowly",
    "flus", "fly", "foes", "foin", "foined", "fold", "folds", "follow", "food", "foot", "for",
    "fora", "forb", "force", "ford", "fore", "forest", "forevers", "forget", "fork", "form",
    "fors", "fort", "foul", "found", "founds", "fount", "four", "fours", "fous", "freak",
    "free", "fresh", "friend", "froe", "frog", "from", "froms", "front", "fros", "frow", "full",
    "fumble", "fun", "funny", "furing", "furs", "fuse", "futs", "gable", "gadly", "gain",
    "gait", "gale", "gall", "game", "gappily", "garden", "gather", "gave", "gear", "gearly",
    "geing", "genely", "genetly", "genitly", "gent", "gentle", "gentry", "genuly", "get",
    "getly", "gets", "ghat", "gibe", "gill", "gimply", "girl", "gist", "gite", "gits", "give",
    "gived", "given", "giver", "gives", "glace", "glad", "glass", "glow", "glowly", "go",
    "goad", "goes", "gold", "golds", "gone", "good", "goon", "goop", "goops", "got", "gout",
    "gown", "great", "green", "grep", "grew", "grog", "grok", "gros", "grot", "ground",
    "grounds", "group", "grow", "growl", "grown", "grows", "guess", "gush", "gust", "guts",
    "guy", "gyve", "hack", "had", "hade", "hadly", "hads", "haed", "haes", "hags", "hair",
    "hajs", "hake", "hale", "half", "hall", "halve", "hame", "hams", "hance", "hances", "hand",
    "handly", "happen", "happy", "haps", "hard", "hardily", "hardy", "hare", "hared", "harely",
    "harkly", "harlly", "harmly", "harpily", "harply", "hartly", "has", "hash", "hasp", "hast",
    "hat", "hate", "hater", "hats", "have", "haved", "haven", "haver", "haves", "haws", "hays",
    "haze", "he", "head", "heady", "heally", "hear", "heard", "heardly", "hearly", "hears",
    "heart", "heat", "heave", "heavy", "height", "heir", "heirs", "held", "helds", "hell",
    "hello", "help", "heme", "hems", "hens", "hently", "heps", "her", "herb", "herbs", "herd",
    "herdly", "herds", "here", "hered", "heres", "herl", "herls", "herm", "herms", "hern",
    "herns", "hero", "heros", "herp", "herps", "herself", "herselfs", "hews", "hey", "heys",
    "hick", "hics", "hids", "hies", "high", "hight", "hill", "him", "hims", "himself",
    "himselfs", "hindly", "hins", "hippily", "hips", "hire", "his", "hiss", "hist", "history",
    "hit", "hither", "hits", "hive", "hoardly", "hods", "hoed", "hoer", "hoers", "hoes", "hold",
    "holds", "hole", "holed", "holes", "holiday", "holm", "holms", "holp", "holps", "hols",
    "holt", "holts", "holy", "home", "hone", "hood", "hoods", "hoop", "hoops", "hope", "hors",
    "horse", "hort", "hose", "hospital", "hostly", "hot", "hotel", "hough", "hound", "hounds",
    "hour", "hours", "house", "hove", "hover", "how", "however", "howevers", "howl", "hows",
    "huge", "human", "humble", "hump", "hundred", "hungry", "hurry", "hurt", "husband", "hush",
    "huts", "i", "ice", "icely", "idea", "idem", "if", "ill", "impart", "imply", "important",
    "imports", "impost", "in", "incise", "include", "included", "includes", "increments",
    "incudes", "incuse", "indly", "inert", "info", "insert", "inserts", "inside", "insided",
    "insider", "insides", "instead", "insteads", "insted", "inter", "interest", "inti", "into",
    "intro", "ints", "invent", "invert", "inverts", "invest", "iolitely", "is", "it", "ited",
    "items", "iterated", "iterates", "its", "itself", "itselfs", "jack", "jell", "jest", "jill",
    "jive", "job", "john", "johned", "join", "joiner", "joing", "joins", "joint", "jointed",
    "joust", "joy", "jumbled", "jumbles", "jump", "jupon", "just", "justs", "juts", "kale",
    "kalong", "keen", "keep", "kently", "kept", "kero", "key", "khan", "khat", "kick", "kid",
    "kidly", "kill", "kinaly", "kind", "kindaly", "kindle", "kindsly", "kine", "kinely",
    "kines", "king", "kingly", "kinkly", "kinly", "kinoly", "kist", "kitchen", "kith", "kits",
    "klong", "knew", "knife", "knot", "know", "known", "koined", "lace", "lack", "ladly",
    "lady", "lager", "lake", "land", "lane", "lanes", "language", "lank", "lapsed", "lardly",
    "large", "larges", "largess", "lase", "laser", "lash", "lass", "last", "lasts", "late",
    "lated", "latent", "later", "lates", "latests", "latex", "lather", "lats", "latter",
    "laudly", "laugh", "lave", "law", "lay", "layer", "leach", "lead", "leally", "learn",
    "lease", "least", "leave", "lect", "led", "leet", "left", "leftovers", "leg", "leing",
    "lend", "lengths", "lengthy", "lent", "lently", "less", "lesson", "let", "lets", "letter",
    "level", "lever", "lice", "licely", "lices", "lick", "lie", "lien", "liens", "lies", "life",
    "lifes", "lift", "light", "like", "likes", "lilt", "lime", "limes", "limply", "line",
    "lined", "lineds", "linen", "linens", "liner", "liners", "lines", "ling", "lings", "linies",
    "link", "links", "linn", "linns", "lino", "linos", "lins", "lint", "lints", "liny", "lion",
    "lip", "lire", "lires", "lisp", "list", "listen", "lists", "lite", "liter", "literate",
    "lites", "lits", "little", "live", "lives", "livided", "lixes", "loadly", "loads", "loaf",
    "loam", "loan", "loed", "loftly", "loin", "loined", "lone", "lones", "long", "look",
    "looks", "loom", "looms", "loon", "loons", "loop", "loops", "loopy", "loos", "loot",
    "loots", "lops", "lord", "lordly", "lose", "lost", "lostly", "lot", "loud", "loup",
    "louply", "loups", "lour", "lourly", "lours", "lout", "loutly", "love", "lover", "low",
    "lowercased", "lowercases", "lowly", "luck", "lumber", "lump", "lunch", "lune", "lunes",
    "luring", "lurs", "lush", "lust", "mace", "mach", "machine", "mad", "made", "madly", "mage",
    "main", "make", "maked", "maker", "makes", "mako", "male", "mall", "maly", "man", "mana",
    "mane", "mangy", "manky", "manly", "mans", "many", "map", "mare", "marely", "mark",
    "market", "marry", "mask", "mast", "mastly", "match", "mate", "matter", "maximums", "may",
    "maya", "maybe", "mayo", "mays", "maze", "mazy", "me", "mead", "meally", "mean", "meany",
    "meat", "meddle", "meet", "member", "men", "mend", "menus", "mere", "message", "met",
    "micely", "mick", "middle", "middled", "middles", "might", "mights", "mighty", "mike",
    "mile", "milk", "mill", "mime", "mimes", "mince", "mind", "mindly", "minds", "mine",
    "mines", "minimums", "minimus", "minis", "minium", "minks", "mins", "mints", "minute",
    "minx", "misplay", "miss", "mist", "mistake", "mistly", "mither", "mize", "mkay", "moatly",
    "moistly", "moke", "mold", "molds", "moltly", "moment", "money", "mong", "month", "moon",
    "mootly", "more", "morning", "morrow", "mort", "mortly", "moshly", "mossly", "most", "moth",
    "mother", "mothing", "motly", "mound", "mounds", "mount", "mountain", "mouth", "move",
    "mover", "movie", "much", "muddle", "multily", "multiple", "multipled", "multiplier",
    "multiplies", "mumble", "mump", "muring", "muse", "mush", "music", "musk", "muss", "must",
    "mustly", "musts", "musty", "muts", "mutt", "my", "myself", "myselfs", "name", "nappily",
    "nardly", "nave", "neap", "neaply", "near", "nearby", "nearly", "nears", "neat", "neatly",
    "neck", "need", "needed", "neighbour", "neing", "neither", "neithers", "neper", "nest",
    "nether", "never", "nevers", "new", "newlined", "newlines", "news", "next", "nice",
    "nicety", "nichely", "nick", "nickly", "nide", "nidely", "niecely", "night", "nine",
    "nined", "ninely", "nines", "ning", "nits", "no", "nobody", "node", "noes", "noise",
    "nonce", "none", "noned", "nones", "nonet", "nons", "noon", "nope", "nor", "norm", "nors",
    "north", "northing", "nose", "noshing", "not", "notching", "note", "nothing", "nothings",
    "notice", "noting", "nots", "now", "nows", "nowt", "numbed", "number", "numbers",
    "numerics", "nuts", "oars", "oast", "ocher", "odes", "of", "off", "offer", "office", "offs",
    "ofted", "often", "oftens", "oftly", "ogive", "oh", "oil", "okay", "old", "olds", "on",
    "once", "onced", "onces", "one", "oned", "ones", "only", "onside", "onto", "ontos",
    "oolitely", "oops", "open", "or", "orded", "order", "orders", "oread", "other", "others",
    "otherwised", "otherwises", "otter", "otto", "ouch", "oudly", "ouds", "ouis", "ounce",
    "our", "ouring", "ours", "ourself", "oust", "out", "outputs", "outride", "outs", "outside",
    "outsided", "outsider", "outsides", "outsize", "oven", "over", "overs", "overt", "own",
    "oyer", "pace", "pack", "pact", "padly", "page", "pain", "paint", "pair", "palace", "pale",
    "pall", "pant", "paper", "pappily", "pardly", "pare", "parely", "parent", "park", "parse",
    "part", "party", "pase", "pash", "pass", "passe", "past", "pasta", "paste", "pasts",
    "pasty", "pats", "paused", "pauses", "pave", "pay", "payt", "pcts", "peace", "peach",
    "peak", "peally", "pear", "pearly", "peck", "pecs", "peen", "peing", "pelitely", "pen",
    "pend", "pently", "people", "peopled", "peoples", "percentaged", "percentages", "percents",
    "percept", "pere", "perhaps", "person", "pertainly", "pest", "pets", "phat", "phis",
    "phone", "photo", "pica", "pice", "picely", "pick", "picks", "picky", "pics", "picture",
    "piddle", "piece", "pill", "pimply", "pine", "pines", "pink", "pint", "pinto", "pish",
    "pith", "pits", "pkts", "place", "placed", "placer", "places", "placet", "plage", "plaice",
    "plan", "plane", "plank", "plant", "plate", "play", "pleas", "please", "pleased", "pleases",
    "ploce", "plow", "plowly", "plug", "plugs", "plum", "plums", "plur", "plurs", "plush",
    "pock", "pocket", "poditely", "point", "police", "policely", "politily", "politly", "pome",
    "ponce", "pone", "poon", "poop", "poops", "poor", "port", "posh", "possible", "post",
    "postly", "pother", "pots", "pound", "pounds", "pour", "pours", "pout", "pouts", "power",
    "practice", "prase", "prep", "prepare", "present", "presents", "preset", "press", "pretty",
    "prevent", "price", "prick", "pring", "prink", "prints", "probable", "problem", "prom",
    "promise", "prompts", "prop", "provability", "provably", "prow", "psst", "pubs", "puck",
    "puds", "pugs", "pull", "puls", "pump", "puns", "punt", "punts", "pups", "puring", "push",
    ...
    "quotients", "racely", "rack", "radio", "radly", "rafter", "ragely", "rain", "raise",
    "rake", "rakely", "rale", "ralely", "rall", "rally", "ran", "rand", "randomize",
    "randomized", "randomizes", "rang", "rapely", "rare", "rarefy", "rarely", "rasher",
    "rately", "rater", "rathe", "rathed", "rather", "rathes", "ratter", "rave", "ravely",
    "razely", "reach", "ready", "real", "really", "realmly", "realty", "ream", "reamly", "reap",
    "reaply", "rear", "rearly", "reason", "receive", "records", "recrement", "recs", "rect",
    "red", "redd", "reed", "reedy", "reelly", "reest", "reflly", "regally", "relay", "relly",
    "remainders", "remember", "remembers", "reminder", "remote", "removed", "renally", "rend",
    "rent", "renter", "rently", "repeal", "repealed", "repeateds", "repeater", "repeats",
    "repent", "repented", "reports", "repp", "reps", "resat", "resent", "reside", "rest",
    "rests", "result", "retd", "retort", "return", "reveals", "revel", "revere", "reveres",
    "reverie", "revers", "reversed", "reverses", "reverso", "rially", "ricely", "rich", "rick",
    "riddle", "ride", "right", "rill", "rime", "rimes", "rindly", "ring", "rise", "rite",
    "rits", "rive", "river", "road", "rock", "rode", "roes", "roll", "room", "roost", "rose",
    "rotund", "rotunds", "roued", "round", "rounds", "rout", "rover", "row", "ruin", "rule",
    "rumble", "rump", "run", "rune", "rung", "runless", "runs", "runt", "ruse", "rush", "rust",
    "ruts", "sable", "sack", "sacly", "sacs", "sad", "saddenly", "sadly", "safe", "safesly",
    "safety", "sage", "sagely", "sagly", "said", "saidly", "sail", "sake", "sakely", "sale",
    "salely", "sally", "salt", "salve", "same", "samely", "sand", "sandly", "sane", "sanely",
    "sang", "saply", "sappily", "sardly", "sat", "sate", "sately", "satly", "save", "saved",
    "savely", "saver", "saves", "saw", "sawly", "saxly", "say", "sayly", "says", "scadly",
    "scan", "scared", "school", "scop", "score", "scow", "scowly", "scrabble", "scrambled",
    "scrambler", "scrambles", "scree", "screed", "screens", "screes", "scuffle", "scum", "sdly",
    "sea", "seally", "sear", "seared", "searly", "seas", "season", "seat", "sech", "second",
    "seconds", "secret", "secs", "sect", "sects", "secund", "secunds", "secy", "see", "seem",
    "seen", "seep", "sees", "seing", "seize", "sell", "semen", "sems", "send", "sense", "sent",
    "sently", "sept", "seqs", "sere", "serve", "service", "set", "seta", "sets", "sett",
    "seven", "sevens", "sever", "several", "sews", "sext", "sgdly", "shad", "shaded", "shadly",
    "shaged", "shahed", "shaked", "shale", "shaled", "shall", "shalls", "shalt", "shamed",
    "shape", "shaped", "shard", "sharded", "shardly", "share", "shareds", "sharer", "shares",
    "sharked", "sharp", "sharped", "shave", "shaved", "shaw", "shawed", "shawl", "shay",
    "shayed", "she", "sheared", "shed", "sheep", "shell", "shes", "shew", "shill", "shim",
    "ship", "shired", "shirt", "shod", "shoe", "shoo", "shoot", "shop", "shore", "shored",
    "short", "shot", "should", "shoulder", "shoulds", "shout", "show", "showly", "shown",
    "shows", "showy", "shred", "shuffled", "shuffler", "shuffles", "shut", "sick", "sics",
    "side", "siftly", "sight", "sign", "sike", "sill", "silver", "simaly", "simly", "simple",
    "since", "sinced", "sinces", "sine", "sines", "sing", "singe", "single", "sinus", "siply",
    "sire", "sister", "sit", "site", "sits", "six", "size", "sized", "sizer", "sizes", "skep",
    "skid", "skill", "skim", "skimp", "skimply", "skin", "skips", "skis", "skit", "sky",
    "slave", "slaw", "slawly", "slay", "sldly", "sleek", "sleep", "sleeps", "sleepy", "sleet",
    "slew", "slewly", "slip", "slit", "slob", "slobly", "sloe", "sloely", "slog", "slogly",
    "sloop", "sloops", "slop", "sloply", "slot", "slotly", "slow", "slows", "slum", "small",
    "smalls", "smalt", "smart", "smell", "smile", "smoke", "snared", "sneak", "snip", "snore",
    "snort", "snot", "snow", "snowly", "snuffle", "so", "soared", "soave", "socs", "soddenly",
    "sodly", "sofaly", "soft", "softaly", "soften", "softily", "softy", "soil", "soke", "sold",
    "soldier", "solds", "sole", "solon", "soma", "some", "somebody", "somed", "someone",
    "someoned", "someones", "somes", "something", "somethings", "sometime", "sometimed",
    "sometimes", "soms", "son", "sone", "song", "soon", "soons", "soot", "sootly", "sora",
    "sorb", "sore", "sori", "sorn", "sorrow", "sorry", "sort", "sorta", "sortly", "sorts",
    "sotly", "souffle", "sound", "sounds", "soup", "sour", "sours", "south", "sowly", "sown",
    "space", "spaced", "spacer", "spaces", "spacey", "spade", "spae", "spake", "spall", "spare",
    "spared", "spate", "spay", "speak", "speaks", "spear", "spec", "special", "speck", "specs",
    "speed", "spend", "spent", "spice", "spill", "spit", "splat", "splint", "splits", "spoke",
    "spoon", "spore", "sport", "spot", "spread", "spring", "sprint", "sprit", "square",
    ...
    "tread", "tree", "trey", "trice", "trip", "trite", "trouble", "trough", "trow", "true",
    "trust", "try", "tuis", "tumble", "turn", "tush", "tuts", "twas", "twat", "twelve",
    "twenty", "twice", "twiced", "twices", "twill", "twine", "two", "twos", "tyke", "type",
    "udder", "umber", "uncle", "under", "understand", "until", "untils", "up", "upon", "upons",
    ...
    "whither", "who", "whoa", "whoevers", "whole", "wholed", "wholes", "wholy", "whom",
    "whomever", "whomp", "whoms", "whop", "whore", "whos", "whose", "whosed", "whoses",
    "whosever", "whoso", "whsle", "why", "whys", "wick", "wide", "width", "wife", "wight",
    "wild", "wile", "will", "wills", "willy", "wilt", "wily", "wimply", "win", "wince", "wind",
    "windly", "window", "wine", "wines", "wing", "winter", "wire", "wise", "wish", "wist",
    "witch", "wite", "with", "withe", "wither", "within", "withing", "withins", "without",
    "withouts", "withs", "withy", "wits", "wive", "woad", "woald", "woes", "wold", "wolds",
    "woman", "women", "wonder", "wood", "woops", "word", "wore", "work", "world", "worry",
    "worse", "wort", "worth", "would", "woulds", "wound", "wounds", "wreak", "wren", "wrest",
    "writ", "write", "writed", "writer", "writes", "writhe", "writs", "wrong", "wrote",
    "yappily", "yard", "yardly", "yare", "yarely", "year", "yearly", "yell", "yellow", "yes",
    "yest", "yesterday", "yet", "yeti", "yets", "you", "young", "your", "yours", "yourself",
    "yourselfs", "yourselves", "yous", "zany", "zappily", "zeally", "zeing", "zeros", "zest",
    "zine", "zines", "zither", "zits", "zone", "zoon", "zounds",
];
